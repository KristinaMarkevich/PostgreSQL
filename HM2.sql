 Импорт данных для таблицы из csv-файла
...
select * from public.students st
...
select min(id) as minid from public.students
 29. Вывести максимальный.
select max(id) MaxId from public.students
